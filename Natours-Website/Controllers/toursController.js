...
exports.resizeTourImages = catchAsync(async (req, res, next) => {
  ...
  await sharp(req.files.imageCover[0].buffer)
    ...
    .toFormat("jpeg")
    .jpeg({ quality: 90 })
    .toFile(`basicrouting/public/img/tours/${req.body.imageCover}`);
  ...
  await Promise.all(
    req.files.images.map(async (e, i) => {
      ...
      await sharp(e.buffer)
        ...
        .toFormat("jpeg")
        .jpeg({ quality: 90 })
        .toFile(`basicrouting/public/img/tours/${imageName}`);
...
exports.aliasTopTours = (req, res, next) => {
  ...
  req.query.fields =
    "name,price,ratingsAverage,summary,difficulty,startDates,locations,imageCover,slug";
  next();
};
